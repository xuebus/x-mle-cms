...
class mysqlbackup{
	...
	private function connect() {
		if (mysql_connect($this->config['host'], $this->config['userName'], $this->config['userPassword'])) {
	...
	private function setFile() {
		...
		$fileName = $this->trimPath($this->config['path'] . self::DIR_SEP . $this->config['newFileName']);
