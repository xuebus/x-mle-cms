<?php /* Smarty version Smarty-3.0.9, created on 2018-10-31 22:49:13
         compiled from "D:/soft/wamp/www/x-mle-cms/inc/templates/manage/article_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:138355bd9c0e9544cc9-32891780%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '633eb2d295d44f10c33bf0adfd4e7ac589ce4adb' => 
    array (
      0 => 'D:/soft/wamp/www/x-mle-cms/inc/templates/manage/article_manage.dwt',
      1 => 1341213700,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '138355bd9c0e9544cc9-32891780',
  'function' => 
  array (
  ),
...
<?php }?><?php echo $_smarty_tpl->getVariable('mle')->value['title_lang'];?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><a href="article_manage.php?trash=0" class="basic_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:none;"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['manage'];?>
</a></td>
							<td><a href="article_manage.php?trash=1" class="advanced_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:url(../inc/templates/manage/images/switch_bg.png);"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['recycle'];?>
</a></td>
						</tr>
					</table>
				</td>
...
" /></td>
				...
				<?php if ($_smarty_tpl->getVariable('mle')->value['channel_show']){?><td><a href="article_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
"><?php echo $_smarty_tpl->tpl_vars['n']->value['channel_title'];?>
</a></td><?php }?>
				<td><a href="article_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
...
" class="title2div" href="../view.php?id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
" href="comment_manage.php?type=1&aid=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
