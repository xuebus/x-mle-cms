<?php /* Smarty version Smarty-3.0.9, created on 2018-10-31 22:49:15
         compiled from "D:/soft/wamp/www/x-mle-cms/inc/templates/manage/product_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:52445bd9c0eb35ada5-65728015%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de0b378b9096d1ea0315e033363207e298f2f356' => 
    array (
      0 => 'D:/soft/wamp/www/x-mle-cms/inc/templates/manage/product_manage.dwt',
      1 => 1341217550,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '52445bd9c0eb35ada5-65728015',
  'function' => 
  array (
  ),
...
','clear',false);
	mle.acsubmit('manage','published','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][5];?>
','published',false);
	mle.acsubmit('manage','unpublished','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][4];?>
','unpublished',false);
...
','restore',false);
	mle.acsubmit('manage','status','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][9];?>
','status',false);
	mle.acsubmit('manage','unstatus','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][10];?>
','unstatus',false);
});
</script>
</head>
...
<?php }?>" />
						...
						<td><a class="button_2" href="product_manage.php?<?php echo rand();?>
...
<?php }?><?php echo $_smarty_tpl->getVariable('mle')->value['title_lang'];?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><a href="product_manage.php?trash=0" class="basic_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:none;"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['manage'];?>
</a></td>
							<td><a href="product_manage.php?trash=1" class="advanced_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:url(../inc/templates/manage/images/switch_bg.png);"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['recycle'];?>
</a></td>
						</tr>
					</table>
				</td>
...
" /></td>
				...
				<?php if ($_smarty_tpl->getVariable('mle')->value['channel_show']){?><td><a href="product_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
"><?php echo $_smarty_tpl->tpl_vars['n']->value['channel_title'];?>
</a></td><?php }?>
				<td><a href="product_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
&category=<?php echo trim($_smarty_tpl->tpl_vars['n']->value['category'],',');?>
"><?php echo $_smarty_tpl->tpl_vars['n']->value['category_title'];?>
</a></td>
				<td style="text-align:left;">
					<a target="_blank" title="<?php echo $_smarty_tpl->tpl_vars['n']->value['title'];?>
" class="title2div" href="../detail.php?id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
" href="comment_manage.php?type=2&aid=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
</span>/<span class="green"><?php echo $_smarty_tpl->tpl_vars['n']->value['sales'];?>
</span></u></a>
					<?php }else{ ?>
...
" /></a><?php }?>
					<a href="product_update.php?id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
" /></a>
					<?php if ($_smarty_tpl->tpl_vars['n']->value['published']){?><a href="<?php echo $_smarty_tpl->getVariable('mle')->value['op_url'];?>
...
" /></a><?php }?>
					<?php if ($_smarty_tpl->tpl_vars['n']->value['status']){?><a href="<?php echo $_smarty_tpl->getVariable('mle')->value['op_url'];?>
&action=unstatus&id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
"><img src="../inc/templates/manage/images/operation/shopping.png" title="<?php echo $_smarty_tpl->getVariable('lang')->value['page']['operation'][10];?>
" /></a><?php }else{ ?><a href="<?php echo $_smarty_tpl->getVariable('mle')->value['op_url'];?>
&action=status&id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
"><img src="../inc/templates/manage/images/operation/cut.png" title="<?php echo $_smarty_tpl->getVariable('lang')->value['page']['operation'][11];?>
" /></a><?php }?>
					<?php }else{ ?>
					<a href="<?php echo $_smarty_tpl->getVariable('mle')->value['op_url'];?>
...
" /></a>
								<a href="javascript:void(0);"><img id="status" src="../inc/templates/manage/images/operation/shopping.png" title="<?php echo $_smarty_tpl->getVariable('lang')->value['page']['volume'][9];?>
" /></a>
								<a href="javascript:void(0);"><img id="unstatus" src="../inc/templates/manage/images/operation/cut.png" title="<?php echo $_smarty_tpl->getVariable('lang')->value['page']['volume'][10];?>
" /></a>
								<?php }else{ ?>
