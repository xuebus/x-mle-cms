<?php /* Smarty version Smarty-3.0.9, created on 2018-10-31 22:49:21
         compiled from "D:/soft/wamp/www/x-mle-cms/inc/templates/manage/picture_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:54665bd9c0f1a13483-45449251%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6f8e55172dd928e59504c7df30206518085dbdb' => 
    array (
      0 => 'D:/soft/wamp/www/x-mle-cms/inc/templates/manage/picture_manage.dwt',
      1 => 1341214026,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '54665bd9c0f1a13483-45449251',
  'function' => 
  array (
  ),
...
<?php }?><?php echo $_smarty_tpl->getVariable('mle')->value['title_lang'];?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><a href="picture_manage.php?trash=0" class="basic_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:none;"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['manage'];?>
</a></td>
							<td><a href="picture_manage.php?trash=1" class="advanced_button" <?php if ($_smarty_tpl->getVariable('mle')->value['get']['trash']==1){?>style="background:url(../inc/templates/manage/images/switch_bg.png);"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['recycle'];?>
</a></td>
						</tr>
					</table>
				</td>
...
" /></td>
				...
				<?php if ($_smarty_tpl->getVariable('mle')->value['channel_show']){?><td><a href="picture_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
"><?php echo $_smarty_tpl->tpl_vars['n']->value['channel_title'];?>
</a></td><?php }?>
				<td><a href="picture_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
...
" href="comment_manage.php?type=3&aid=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
