<?php /* Smarty version Smarty-3.0.9, created on 2018-10-31 22:50:15
         compiled from "D:/soft/wamp/www/x-mle-cms/inc/templates/frontend/default/download.tpl" */ ?>
<?php /*%%SmartyHeaderCode:193395bd9c127a51229-41883595%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '00a1c8210d5710d2a9a60588f8979d7751be0672' => 
    array (
      0 => 'D:/soft/wamp/www/x-mle-cms/inc/templates/frontend/default/download.tpl',
      1 => 1346786732,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193395bd9c127a51229-41883595',
  'function' => 
  array (
  ),
...
<div class="classify"><?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable;
 $_from = category::data(4,$_smarty_tpl->getVariable('mle')->value['channel_id'],0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<div class="box">
	<div class="main">
		<div class="titlebar">
			<ol class="title"><?php echo $_smarty_tpl->getVariable('mle')->value['channel_title'];?>
</ol>
...
</a> &gt;&gt; <?php echo $_smarty_tpl->getVariable('mle')->value['channel_title'];?>
</ol>
		</div>
		
		<!-- 列表数据，全部分类 -->
		<?php  $_smarty_tpl->tpl_vars['d'] = new Smarty_Variable;
 $_from = download::data(0,10,0,$_smarty_tpl->getVariable('mle')->value['channel_id'],0,0,0,0,0,1,0,0,3); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
...
" class="gen"><?php echo $_smarty_tpl->tpl_vars['t']->value['title'];?>
 ...
 $_from = download::data(0,10,1,$_smarty_tpl->getVariable('mle')->value['channel_id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['d']->key => $_smarty_tpl->tpl_vars['d']->value){
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['d']->value['title_format'];?>
		...
		<div class="well">
			<?php  $_smarty_tpl->tpl_vars['d'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = download::data(9,10,0,$_smarty_tpl->getVariable('mle')->value['channel_id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['d']->key => $_smarty_tpl->tpl_vars['d']->value){
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['d']->key;
?>
