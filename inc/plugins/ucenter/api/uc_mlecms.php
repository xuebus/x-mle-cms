...
UC_ENABLED === true or die('mlecms disabled.'); 
$dbhost = UC_DBHOST;
$dbuser = UC_DBUSER;
$dbpw = UC_DBPW;
$dbname = UC_DBNAME;
...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		$user_data = member::get_user($get['username'],1); 
		header('P3P: CP="CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR"');  
		empty($user_data) or member::set_login_cookie($user_data,0); 
	}
	...
	function updatepw($get, $post) {
		...
		$username23 = $get['username'];
		$password23 = $get['password'];
		return API_RETURN_SUCCEED;
	}
